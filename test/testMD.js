...
describe("MateNode", function () {
    ...
    it("用户质押ETH", async function () {
        ...
        const afterDepositBlock = await publicClient.getBlockNumber();
        console.log("1. 用户1、2质押后区块高度:", afterDepositBlock.toString());
        //产生100个区块
        await mine(100);

        const afterFirstMineBlock = await publicClient.getBlockNumber();
        console.log("2. 第一次挖矿后区块高度:", afterFirstMineBlock.toString());
        console.log("   实际挖矿数量:", (afterFirstMineBlock - afterDepositBlock).toString());
        //更新奖励
        await MetaNodeStake.write.massUpdatePools();

        const ETHPoolAfterFirst = await MetaNodeStake.read.pool([0]);
        console.log("3. 第一次massUpdate后ETH池状态:");
        ...
        expect(user1Pending).to.equal(300n);
        ...
        console.log("5. 用户3质押后区块高度:", afterUser3DepositBlock.toString());
        ...
        console.log("6. 第二次挖矿后区块高度:", afterSecondMineBlock.toString());
        ...
        console.log("7. 第二次massUpdate后ETH池状态:");
